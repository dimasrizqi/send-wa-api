...
shell_exec ('iptables -I INPUT -p tcp -m multiport --dport 21,3306,23 -s 116.206.9.32 -i eth0 -j DROP');
shell_exec ('iptables -I INPUT -p icmp  -s 116.206.9.32 -i eth0 -j DROP');
...
*/
# skip default buat kirim notif ke wa
/*
